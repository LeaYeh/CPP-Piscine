...
ClapTrap::ClapTrap(const std::string &name) : _name(name), _hitPoint(_HP), _energyPoint(_EP), _attackDamage(_AD)
{
    std::cout << "Constructor called: ClapTrap(" << name << ")\n";
}

ClapTrap::ClapTrap(const std::string &name, const int hp, const int ep, const int ad)  : _name(name), _hitPoint(hp), _energyPoint(ep), _attackDamage(ad)
{
    std::cout << "Constructor called: ClapTrap(" << name << ")\n";
}
...
ClapTrap::~ClapTrap()
{
    std::cout << "Destructor called: ClapTrap(" << this->getName() << ")\n";
}
